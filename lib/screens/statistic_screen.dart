...
class StatisticScreen extends StatefulWidget {
  final Map<String, Map<int, List<DiseaseModel>>> data;
...
class _StatisticScreenState extends State<StatisticScreen> {
  late final Map<String, Map<int, List<DiseaseModel>>> _data;

  late String _city;
  late String _town;
  late Diseases? _selectedDisease;

  void _onChangedCity(String? value) {
    setState(() {
      _city = value!;
      _town = location[value]!.keys.first;
    });
  }
  ...
  void _onChangedDisease(Diseases? value) {
    setState(() {
  ...
  void initState() {
    super.initState();
    _city = location.keys.first;
    _town = location[_city]!.keys.first;
    _selectedDisease = Diseases.cold;
    _data = widget.data;
  }
